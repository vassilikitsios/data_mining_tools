...
# clean_sql.py
'''
Contains subroutines to read in the data from file and store in SQL database.
'''
...
def read_and_clean_data(input_dir):
    '''
    Read in data from file and store in SQL database.
    '''
    #-------------------------------------------------------------
...
def create_sql_database(cur,database_name):
    '''
    If it does not exist create the SQL into which the tables will be created
...
def create_sql_table(cur,table_name):
    '''
    For a given database, if it does not exist create the SQL table into which 
...
def get_column_names(filename):
    '''
    Get the column names of a given input file.
    '''
    fin = open(filename,'r')
...
def populate_sql_table(cur,table_name,filename,var_type):
    '''
    Fill the SQL table with the data read in from file.
    '''
